# Cloudfront module for Serverless-Apps for Capterra.
    This module is for creating CF distro for spotlight-ui in Capterra.
    This module is forked from Capterra in-house TF module for "Cloudfront_Serverless_Apps". This is modified specifically for spotlight-ui requirements.
...
* region_aws -- This is region where tf template is to be deployed. Default: us-west-2
...
* primary_s3_bucket -- Primary S3 Bucket name that CF distro S3 origin will point to.
* primary_s3_bucket_domainsuffix -- Primary S3 Bucket domain suffix to append to s3 bucket name so that regional_domain_name can be constructed. Eg: s3.amazonaws.com"
* primary_s3_bucket_arn_prefix -- Prefix to be added on Primary_S3_Bucket to construct arn so that is can be used in policy to allow access via OAI. Eg: arn:aws:s3:::
...
module "cf_dist_serverless" {
  #source                         = "/Users/sargupta/Capterra-github/terraform/modules/Cloudfront_Serverless_Apps-DR/capterra-spotlight-ui/cloudfront_serverless_module-spotlight_ui"
  #source                         = "../cloudfront_serverless_module-spotlight"
  source                         = "git@github.com:capterra/terraform.git//modules/Cloudfront_Serverless_Apps-DR/capterra-spotlight-ui/cloudfront_serverless_module-spotlight_ui
  name                           = "spotlight"
  #stage                           = "dev"
  stage                          = var.stage
  vertical                       = "capterra"
  ...
  #cert_domain_name              = "spotlight-ui-dr.capterra.com"
...
variable "cloudformationstackname" {
  description = "cloudformationstackname to be passed to module. Eg: capterra-spotlight-ui-service-prod-dr"
 }

 variable "cert_domain_name" {
  description = "cert_domain_name to be passed to module. Eg: spotlight-dr.capterra.com"
 }
 ...
 variable "primary_s3_bucket" {
     type = string
     description = "Primary S3 Bucket name that CF distro S3 origin will point to. Eg: spotlight-ui-prd-dr"
 }
