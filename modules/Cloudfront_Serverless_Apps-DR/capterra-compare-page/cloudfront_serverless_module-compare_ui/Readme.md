# Cloudfront module for Serverless-Apps for Capterra.
    This module is for creating CF distro for compare-ui in Capterra for DR deployments.
...
#### What this module will do?
  ```
  # Create Amazon certificate (ACM) in us-east-1 explicitly for DR.
...
variable "cloudformationstackname" {
  description = "cloudformationstackname to be passed to module. Eg: capterra-directory-page-ui-service-prod"
}

variable "cert_domain_name" {
  description = "cert_domain_name to be passed to module. Eg: compare-ui-dr.capterra.com"
}
...
variable "primary_s3_bucket" {
    type = string
    description = "Primary S3 Bucket name that CF distro S3 origin will point to. Eg: directory-page-ui-dr"
}
