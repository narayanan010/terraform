...
variable "cloudformationstackname" {
    type = string
    description = "Name of cloudformation Stack to grab Outputs from (API Gateway endpoint, S3 bucket etc). Eg: capterra-directory-page-ui-service-prod"
}
...
variable "cert_domain_name" {
    type = "string"
    description = "This is certificate domain that needs to be whitelisted. Format e.g compare-ui-dr.capterra.com"
}
