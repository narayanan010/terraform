...
variable "web_acl_arn" {
    type = string
    description = "Input the name of the WAF web acl created. WAF Web ACL must exist in the WAF Global (CloudFront) region. ex - 'cap-waf-acl-glbl-allow-default-ips' "
    default = ""
}

variable "waf_required" {
    description = "Input true or false whether WAF is needed or not"
    default = true
}

variable "bucketname" {
    description = "bucket name to be used in cloudfront origin. Eg: forms-as-a-service-examples-prod"
    default = ""
}

variable "origin_path" {
    description = "origin_path to be used in cloudfront origin. Eg : /prod"
    default = ""
}
#R53 Variables
