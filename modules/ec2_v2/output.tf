...
output "key_name" {
  ...
  value       = aws_instance.this[0].key_name
}
...
output "security_groups" {
  ...
  value       = aws_instance.this[0].security_groups
}
...
output "subnet_id" {
  ...
  value       = aws_instance.this[0].subnet_id
}

output "credit_specification" {
  description = "List of credit specification of instances"
  value       = aws_instance.this[0].credit_specification
}
