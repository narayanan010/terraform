# Cloudfront module for Serverless-Apps for Capterra.
    This module is for creating CF distro for compare-ui in Capterra.
...
module "cf_dist_serverless" {
  ...
  source                         = "../cloudfront_serverless_module-compare_ui"
  name                           = "compare"
  #stage                           = "dev"
  stage                          = var.stage
  vertical                       = "capterra"
...
```
  ...
  description = "cloudformationstackname to be passed to module. Eg: capterra-compare-ui-123-service-dev"
  }
