...
variable "primary_s3_bucket" {
  type        = string
  description = "Primary S3 Bucket name that CF distro S3 origin will point to."
}
...
variable "cert_domain_name" {
  type        = string
  description = "This is certificate domain that needs to be whitelisted. Format e.g serverlessapp-test.capstage.net"
}
...
variable "s3_path_pattern" {
  type        = string
  description = "The Path Pattern for the Ordered Cache Behavior. Eg: search/assets/*"
}
...
variable "s3_path_pattern_semCompareStatic" {
  type        = string
  description = "The Path Pattern for the Ordered Cache Behavior for Compare semCompareStatic. Eg: semCompare/semCompareStatic/*"
}

variable "s3_path_pattern_semDisplay" {
  type        = string
  description = "The Path Pattern for the Ordered Cache Behavior for semDisplay. Eg: semDisplay/assets/*"
}

variable "s3_path_pattern_semSearch" {
  type        = string
  description = "The Path Pattern for the Ordered Cache Behavior for semSearch. Eg: semSearch/assets/*"
}
...
variable "s3_path_pattern_semCompareMobile" {
  type        = string
  description = "The Path Pattern for the Ordered Cache Behavior for semCompareMobile. Eg: semCompareMobile/semCompareMobileStatic/*"
}

#Added below section for supporting the SEMCOMPAREMOBILE-ASSETS files rendering from S3 via OAI. Added Path-Pattern for Assets/* - Date 05/02/2021

variable "s3_path_pattern_semCompareMobile_assets" {
  type        = string
  description = "The Path Pattern for the Ordered Cache Behavior for semCompareMobile. Eg: semCompareMobile/assets/*"
}
...
variable "s3_path_pattern_semCompareServices_assets" {
  type        = string
  description = "The Path Pattern for the Ordered Cache Behavior for semCompareServices. Eg: semCompareServices/assets/*"
}
...
variable "s3_path_pattern_semCompareServicesMobile_assets" {
  type        = string
  description = "The Path Pattern for the Ordered Cache Behavior for semCompareServicesMobile. Eg: semCompareServicesMobile/assets/*"
}
...
variable "s3_path_pattern_semPPL_assets" {
  type        = string
  description = "The Path Pattern for the Ordered Cache Behavior for semPPL. Eg: semPPL/assets/*"
}
...
variable "s3_path_pattern_getbetterlist_assets" {
  type        = string
  description = "The Path Pattern for the Ordered Cache Behavior for semPPL. Eg: shortlist/assets/*"
}
