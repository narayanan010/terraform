# This module is forked from Capterra in-house TF module for "Cloudfront_Serverless_Apps". This is modified specifically for SEM-Pages requirements.
# This module should:
## 
## 
...
data "aws_s3_bucket" "cf_primary_bucket" {
  provider = aws.primary_cf_account
...
resource "aws_cloudfront_distribution" "s3_distribution" {
  ...
  ordered_cache_behavior {
    ...
    max_ttl                = var.ordered_cache_behavior_max_ttl
    min_ttl                = var.ordered_cache_behavior_min_ttl
    path_pattern           = var.s3_path_pattern_semCompareStatic
    smooth_streaming       = false
    target_origin_id       = "origin-s3-${var.namespace}-${var.name}-${var.vertical}-${var.stage}"
    viewer_protocol_policy = var.ordered_cache_behavior_viewer_protocol_policy
  }
  ...
  ordered_cache_behavior {
    ...
    max_ttl                = var.ordered_cache_behavior_max_ttl
    min_ttl                = var.ordered_cache_behavior_min_ttl
    path_pattern           = var.s3_path_pattern_semDisplay
    smooth_streaming       = false
    target_origin_id       = "origin-s3-${var.namespace}-${var.name}-${var.vertical}-${var.stage}"
    viewer_protocol_policy = var.ordered_cache_behavior_viewer_protocol_policy
  }
  ...
  ordered_cache_behavior {
    ...
    max_ttl                = var.ordered_cache_behavior_max_ttl
    min_ttl                = var.ordered_cache_behavior_min_ttl
    path_pattern           = var.s3_path_pattern_semSearch
    smooth_streaming       = false
    target_origin_id       = "origin-s3-${var.namespace}-${var.name}-${var.vertical}-${var.stage}"
    viewer_protocol_policy = var.ordered_cache_behavior_viewer_protocol_policy
  }
  ...
  ordered_cache_behavior {
    ...
    max_ttl                = var.ordered_cache_behavior_max_ttl
    min_ttl                = var.ordered_cache_behavior_min_ttl
    path_pattern           = var.s3_path_pattern_semCompareMobile
    smooth_streaming       = false
    target_origin_id       = "origin-s3-${var.namespace}-${var.name}-${var.vertical}-${var.stage}"
    viewer_protocol_policy = var.ordered_cache_behavior_viewer_protocol_policy
  }
  ...
  ordered_cache_behavior {
    ...
    max_ttl                = var.ordered_cache_behavior_max_ttl
    min_ttl                = var.ordered_cache_behavior_min_ttl
    path_pattern           = var.s3_path_pattern_semCompareMobile_assets
    smooth_streaming       = false
    target_origin_id       = "origin-s3-${var.namespace}-${var.name}-${var.vertical}-${var.stage}"
    viewer_protocol_policy = var.ordered_cache_behavior_viewer_protocol_policy
  }
  ...
  ordered_cache_behavior {
    ...
    max_ttl                = var.ordered_cache_behavior_max_ttl
    min_ttl                = var.ordered_cache_behavior_min_ttl
    path_pattern           = var.s3_path_pattern_semCompareServices_assets
    smooth_streaming       = false
    target_origin_id       = "origin-s3-${var.namespace}-${var.name}-${var.vertical}-${var.stage}"
    viewer_protocol_policy = var.ordered_cache_behavior_viewer_protocol_policy
  }
  ...
  ordered_cache_behavior {
    ...
    max_ttl                = var.ordered_cache_behavior_max_ttl
    min_ttl                = var.ordered_cache_behavior_min_ttl
    path_pattern           = var.s3_path_pattern_semCompareServicesMobile_assets
    smooth_streaming       = false
    target_origin_id       = "origin-s3-${var.namespace}-${var.name}-${var.vertical}-${var.stage}"
    viewer_protocol_policy = var.ordered_cache_behavior_viewer_protocol_policy
  }
  ...
  ordered_cache_behavior {
    ...
    max_ttl                = var.ordered_cache_behavior_max_ttl
    min_ttl                = var.ordered_cache_behavior_min_ttl
    path_pattern           = var.s3_path_pattern_semPPL_assets
    smooth_streaming       = false
    target_origin_id       = "origin-s3-${var.namespace}-${var.name}-${var.vertical}-${var.stage}"
    viewer_protocol_policy = var.ordered_cache_behavior_viewer_protocol_policy
  }

  #Added below section for supporting the get-better-list-ASSETS files rendering from S3 via OAI. Added Path-Pattern for Assets/* - Date 07/25/2023
  ...
  ordered_cache_behavior {
    ...
    max_ttl                = var.ordered_cache_behavior_max_ttl
    min_ttl                = var.ordered_cache_behavior_min_ttl
    path_pattern           = var.s3_path_pattern_getbetterlist_assets
    smooth_streaming       = false
    target_origin_id       = "origin-s3-${var.namespace}-${var.name}-${var.vertical}-${var.stage}"
    viewer_protocol_policy = var.ordered_cache_behavior_viewer_protocol_policy
  }
...
resource "aws_cloudfront_origin_access_identity" "origin_access_identity" {
  provider = aws.primary_cf_account
  comment  = "OAI for serverless app named ${var.name} and bucket ${var.primary_s3_bucket}"
}
