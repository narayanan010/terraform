# Cloudfront module for Serverless-Apps for Capterra.
    This module is for creating CF distro for sem-pages in Capterra.
...
```
  ...
  ##description = "cloudformationstackname to be passed to module. Eg: capterra-sem-ui-123-service-dev"
  ##}
