# Cloudfront module for Serverless-Apps for Capterra.
    This module is for creating CF distro for capterra-search in Capterra.
    This module is forked from Capterra in-house TF module for "Cloudfront_Serverless_Apps". This is modified specifically for capterra-search requirements.
...
```
  ...
  description = "cloudformationstackname to be passed to module. Eg: capterra-search-123-service-dev"
  }

  variable "cert_domain_name" {
  description = "cert_domain_name to be passed to module. Eg: search-<env>-<prnumber>.capstage.net"
  }
