...
module "cf_dist_serverless" {
  ...
  #cert_domain_name              = "spotlight.capstage.net"
...
```
  ...
  description = "cloudformationstackname to be passed to module. Eg: capterra-spotlight-ui-123-service-dev"
  }

  variable "cert_domain_name" {
  description = "cert_domain_name to be passed to module. Eg: spotlight-ui-<env>-<prnumber>.capstage.net"
  }

  variable "stage" {
  description = "stage to be passed to module. Eg: dev, stg etc"
  }
