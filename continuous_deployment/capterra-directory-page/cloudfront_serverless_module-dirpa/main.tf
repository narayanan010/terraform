# This module is forked from Capterra in-house TF module for "Cloudfront_Serverless_Apps". This is modified specifically for dirpa requirements.
# This module should:
...
resource "aws_cloudfront_distribution" "s3_distribution" {
  ...
  # This section was added for robots.txt only for DIRPA
  origin {
    domain_name = "${var.primary_s3_bucket}.${var.primary_s3_bucket_domainsuffix}"
    origin_id   = "origin-s3-${var.namespace}-${var.name}-${var.vertical}-${var.stage}-robots"
    origin_path = element(split("/*", var.s3_path_pattern), 2)
  ...
  # This section is added for buyersGuide/assets/*
  ...
  ordered_cache_behavior {
    ...
    max_ttl                = var.ordered_cache_behavior_max_ttl
    min_ttl                = var.ordered_cache_behavior_min_ttl
    path_pattern           = var.s3_path_pattern_buyersGuide
    smooth_streaming       = false
    target_origin_id       = "origin-s3-${var.namespace}-${var.name}-${var.vertical}-${var.stage}"
    viewer_protocol_policy = var.ordered_cache_behavior_viewer_protocol_policy
  }
  ...
  # This section is added for common/assets/*
  ...
  ordered_cache_behavior {
    ...
    max_ttl                = var.ordered_cache_behavior_max_ttl
    min_ttl                = var.ordered_cache_behavior_min_ttl
    path_pattern           = var.s3_path_pattern_common
    smooth_streaming       = false
    target_origin_id       = "origin-s3-${var.namespace}-${var.name}-${var.vertical}-${var.stage}"
    viewer_protocol_policy = var.ordered_cache_behavior_viewer_protocol_policy
  }
  ...
  # This section is added for knowledgeBase/assets/*
  ...
  ordered_cache_behavior {
    ...
    max_ttl                = var.ordered_cache_behavior_max_ttl
    min_ttl                = var.ordered_cache_behavior_min_ttl
    path_pattern           = var.s3_path_pattern_knowledgeBase
    smooth_streaming       = false
    target_origin_id       = "origin-s3-${var.namespace}-${var.name}-${var.vertical}-${var.stage}"
    viewer_protocol_policy = var.ordered_cache_behavior_viewer_protocol_policy
  }
  ...
  # This section is added for buyersGuideContentful/assets/*
  ...
  ordered_cache_behavior {
    ...
    max_ttl                = var.ordered_cache_behavior_max_ttl
    min_ttl                = var.ordered_cache_behavior_min_ttl
    path_pattern           = var.s3_path_pattern_buyersGuideContentful
    smooth_streaming       = false
    target_origin_id       = "origin-s3-${var.namespace}-${var.name}-${var.vertical}-${var.stage}"
    viewer_protocol_policy = var.ordered_cache_behavior_viewer_protocol_policy
  }

# This section is added for /shortlist/assets/*
  ...
  ordered_cache_behavior {
    ...
    max_ttl                = var.ordered_cache_behavior_max_ttl
    min_ttl                = var.ordered_cache_behavior_min_ttl
    path_pattern           = var.s3_path_pattern_shortlist
    smooth_streaming       = false
    target_origin_id       = "origin-s3-${var.namespace}-${var.name}-${var.vertical}-${var.stage}"
    viewer_protocol_policy = var.ordered_cache_behavior_viewer_protocol_policy
  }
  ...
  # This section was added for robots.txt for DIRPA
  ...
  ordered_cache_behavior {
    ...
    max_ttl                = var.ordered_cache_behavior_max_ttl
    min_ttl                = var.ordered_cache_behavior_min_ttl
    path_pattern           = var.s3_path_pattern_robots
    smooth_streaming       = false
    target_origin_id       = "origin-s3-${var.namespace}-${var.name}-${var.vertical}-${var.stage}-robots"
    viewer_protocol_policy = var.ordered_cache_behavior_viewer_protocol_policy
  }
