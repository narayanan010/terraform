...
variable "s3_path_pattern_robots" {
  type        = string
  description = "The Path Pattern for the Ordered Cache Behavior for robots for DIRPAs. Eg: robots.txt"
}

variable "s3_path_pattern_buyersGuide" {
  type        = string
  description = "The Path Pattern for the Ordered Cache Behavior. Eg: /buyersGuide/assets/*"
}

variable "s3_path_pattern_common" {
  type        = string
  description = "The Path Pattern for the Ordered Cache Behavior. Eg: /common/assets/*"
}

variable "s3_path_pattern_knowledgeBase" {
  type        = string
  description = "The Path Pattern for the Ordered Cache Behavior. Eg: /knowledgeBase/assets/*"
}

variable "s3_path_pattern_buyersGuideContentful" {
  type        = string
  description = "The Path Pattern for the Ordered Cache Behavior. Eg: /buyersGuideContentful/assets/*"
}
...
variable "whitelisted_names" {
  type        = list(string)
  description = "List of whitelisted names need to be passed in cookies"
  default     = ["productDedup"]
}
...
variable "s3_path_pattern_shortlist" {
  type        = string
  description = "The Path Pattern for the Ordered Cache Behavior. Eg: /shortlist/assets/*"
}
