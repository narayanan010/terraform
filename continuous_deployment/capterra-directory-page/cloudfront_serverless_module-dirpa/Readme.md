# Cloudfront module for Serverless-Apps for Capterra.
    This module is for creating CF distro for DIRPA in Capterra.
...
```
  ...
  description = "cloudformationstackname to be passed to module. Eg: capterra-dirpa-ui-123-service-dev"
  }

  variable "cert_domain_name" {
  description = "cert_domain_name to be passed to module. Eg: dirpa-ui-<env>-<prnumber>.capstage.net"
  }
