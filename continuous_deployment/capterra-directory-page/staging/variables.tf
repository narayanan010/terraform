...
variable "cloudformationstackname" {
  type        = string
  description = "cloudformationstackname to be passed to module. Eg: capterra-dirpa-ui-<PRNUMBER>-service-<ENV>"
}
...
variable "primary_s3_bucket" {
  type        = string
  description = "Primary S3 Bucket name that CF distro S3 origin will point to. Eg: dirpa-ui-<ENV>-<PRNUMBER>"
}
