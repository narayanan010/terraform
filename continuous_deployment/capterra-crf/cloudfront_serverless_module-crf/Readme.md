# Cloudfront module for Serverless-Apps for Capterra.
    ...
    This module is forked from Capterra in-house TF module for "Cloudfront_Serverless_Apps". This is modified specifically for crf requirements.
...
module "cf_dist_serverless" {
  ...
  #cert_domain_name              = "reviews.capstage.net"
