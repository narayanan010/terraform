...
variable "s3_path_pattern" {
  type        = string
  description = "The Path Pattern for the Ordered Cache Behavior. Eg: spotlight/assets/*"
}
...
variable "s3_path_pattern_storybook" {
  type        = string
  description = "The Path Pattern for the second Ordered Cache Behavior. Eg: storybook/*"
}

variable "storybook_ordered_cache_behavior_default_ttl" {
  type        = string
  description = "The default_ttl for the storybook Ordered Cache Behavior. Eg: 31536000"
  default     = "0"
}

variable "storybook_ordered_cache_behavior_min_ttl" {
  type        = string
  description = "The min_ttl for the storybook Ordered Cache Behavior. Eg: 31536000"
  default     = "0"
}

variable "storybook_ordered_cache_behavior_max_ttl" {
  type        = string
  description = "The max_ttl for the storybook Ordered Cache Behavior. Eg: 31536000"
  default     = "0"
}

variable "s3_path_pattern_next" {
  type        = string
  description = "The Path Pattern for the third Ordered Cache Behavior. Eg: _next/*"
}

variable "next_ordered_cache_behavior_default_ttl" {
  type        = string
  description = "The default_ttl for the next Ordered Cache Behavior. Eg: 31536000"
  default     = "0"
}

variable "next_ordered_cache_behavior_min_ttl" {
  type        = string
  description = "The min_ttl for the next Ordered Cache Behavior. Eg: 31536000"
  default     = "0"
}

variable "next_ordered_cache_behavior_max_ttl" {
  type        = string
  description = "The max_ttl for the next Ordered Cache Behavior. Eg: 31536000"
  default     = "0"
}
