...
variable "cloudformationstackname" {
	description = "cloudformationstackname to be passed to module. Eg: capterra-homepage-ui-<PRNUMBER>-service-<ENV>"
}
...
variable "primary_s3_bucket" {
    type = string
    description = "Primary S3 Bucket name that CF distro S3 origin will point to. Eg: homepage-ui-<ENV>-<PRNUMBER>"
}
