# Cloudfront module for Serverless-Apps for Capterra.
    This module is for creating CF distro for capterra-static-ui in Capterra.
    This module is forked from Capterra in-house TF module for "Cloudfront_Serverless_Apps". This is modified specifically for capterra-static-ui requirements.
...
```
  ...
  description = "cloudformationstackname to be passed to module. Eg: capterra-homepage-ui-123-service-dev"
  }

  variable "cert_domain_name" {
  description = "cert_domain_name to be passed to module. Eg: homepage-ui-<env>-<prnumber>.capstage.net"
  }
