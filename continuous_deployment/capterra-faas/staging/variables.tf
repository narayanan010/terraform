...
#	description = "cloudformationstackname to be passed to module. Eg: capterra-search-<PRNUMBER>-service-<ENV>"
#}

variable "cert_domain_name" {
	description = "cert_domain_name to be passed to module. Eg: forms-as-a-service-<ENV>-<PR_NUMBER>.capstage.net"
}
...
variable "primary_s3_bucket" {
    type = string
    description = "Primary S3 Bucket name that CF distro S3 origin will point to. Eg: forms-as-a-service-<ENV>-<PR_NUMBER>"
}
