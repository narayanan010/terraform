...
variable "cloudformationstackname" {
  type        = string
  description = "cloudformationstackname to be passed to module. Eg: capterra-user-workspace-<PRNUMBER>-<ENV>"
}

variable "cert_domain_name" {
  type        = string
  description = "cert_domain_name to be passed to module. Eg: user-workspace-<ENV>-<PR_NUMBER>.capstage.net"
}
...
variable "primary_s3_bucket" {
  type        = string
  description = "Primary S3 Bucket name that CF distro S3 origin will point to. Eg: user-workspace-<ENV>-<PR_NUMBER>"
}
