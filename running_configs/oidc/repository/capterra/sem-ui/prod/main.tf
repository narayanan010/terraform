...
data "aws_iam_policy_document" "github_actions_sem_ui" {
  ...
  statement {
    ...
    resources = [
      "arn:aws:cloudformation:*:${data.aws_caller_identity.current.account_id}:stack/capterra-sem-ui-*/*"
    ]
  }
  ...
  statement {
    ...
    resources = [
      ...
      "arn:aws:lambda:*:${data.aws_caller_identity.current.account_id}:function:capterra-sem-ui*",
      "arn:aws:lambda:*:${data.aws_caller_identity.current.account_id}:function:capterra-sem-ui*:*",
  ...
  statement {
    ...
    resources = [
      "arn:aws:logs:*:${data.aws_caller_identity.current.account_id}:log-group:/aws/lambda/capterra-sem-ui*",
      "arn:aws:logs:*:${data.aws_caller_identity.current.account_id}:log-group:/aws/api-gateway/capterra-sem-ui*",
      "arn:aws:logs:*:${data.aws_caller_identity.current.account_id}:log-group:/aws/lambda/capterra-sem-ui*:log-stream:*",
      "arn:aws:logs:*:${data.aws_caller_identity.current.account_id}:log-group:/aws/api-gateway/capterra-sem-ui*:log-stream*"
    ]
  }
