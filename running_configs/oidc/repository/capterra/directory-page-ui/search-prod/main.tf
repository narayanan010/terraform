...
data "aws_iam_policy_document" "github_actions_dirpa_ui" {
  ...
  statement {
    ...
    resources = [
       "arn:aws:cloudformation:*:${data.aws_caller_identity.current.account_id}:stack/capterra-directory-page-ui-service-prod/*",
       "arn:aws:cloudformation:*:${data.aws_caller_identity.current.account_id}:stack/capterra-directory-page-ui-service-prod-dr/*",
       "arn:aws:cloudformation:*:${data.aws_caller_identity.current.account_id}:stack/capterra-directory-page-ui-*/*",
       "arn:aws:cloudformation:*:${data.aws_caller_identity.current.account_id}:stack/capterra-directory-page-ui-*"
    ]
  }
  ...
  statement {
    ...
    resources = [
      ...
      "arn:aws:iam::${data.aws_caller_identity.current.account_id}:role/capterra-directory-page-ui",
      "arn:aws:iam::296947561675:role/NewRelicLambdaIntegrationRole_151038"
      ]
  }
  ...
  statement {
    ...
    resources = [
      ...
      "arn:aws:lambda:*:${data.aws_caller_identity.current.account_id}:function:capterra-directory-page-ui*",
      "arn:aws:lambda:*:${data.aws_caller_identity.current.account_id}:function:capterra-directory-page-ui*:*",
  ...
  statement {
    ...
    resources = [
      "arn:aws:logs:*:${data.aws_caller_identity.current.account_id}:log-group:/aws/lambda/capterra-directory-page-ui*",
      "arn:aws:logs:*:${data.aws_caller_identity.current.account_id}:log-group:/aws/api-gateway/capterra-directory-page-ui*",
      "arn:aws:logs:*:${data.aws_caller_identity.current.account_id}:log-group:/aws/lambda/capterra-directory-page-ui*:log-stream:*",
      "arn:aws:logs:*:${data.aws_caller_identity.current.account_id}:log-group:/aws/api-gateway/capterra-directory-page-ui*:log-stream*"
    ]
  }
