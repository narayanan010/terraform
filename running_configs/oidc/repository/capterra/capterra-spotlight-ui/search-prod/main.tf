...
data "aws_iam_policy_document" "github_actions_spotlight_ui" {
  ...
  statement {
    ...
    resources = [
      "arn:aws:cloudformation:*:${data.aws_caller_identity.current.account_id}:stack/capterra-spotlight-ui-*/*",
      "arn:aws:cloudformation:*:${data.aws_caller_identity.current.account_id}:stack/capterra-spotlight-ui-service-prod/*",
      "arn:aws:cloudformation:*:${data.aws_caller_identity.current.account_id}:stack/capterra-spotlight-ui-*",
      "arn:aws:cloudformation:*:${data.aws_caller_identity.current.account_id}:stack/capterra-spotlight-ui-service-prod-dr/*",
    ]
  }
  ...
  statement {
    ...
    resources = [
      "arn:aws:lambda:*:${data.aws_caller_identity.current.account_id}:function:capterra-spotlight-ui*",
      "arn:aws:lambda:*:${data.aws_caller_identity.current.account_id}:function:capterra-spotlight-ui*:*",
      "arn:aws:lambda:*:${data.aws_caller_identity.current.account_id}:function:newrelic*",
  ...
  statement {
    ...
    resources = [
      "arn:aws:logs:*:${data.aws_caller_identity.current.account_id}:log-group:/aws/lambda/capterra-spotlight-ui*",
      "arn:aws:logs:*:${data.aws_caller_identity.current.account_id}:log-group:/aws/api-gateway/capterra-spotlight-ui*",
      "arn:aws:logs:*:${data.aws_caller_identity.current.account_id}:log-group:/aws/lambda/capterra-spotlight-ui*:log-stream:*",
      "arn:aws:logs:*:${data.aws_caller_identity.current.account_id}:log-group:/aws/api-gateway/capterra-spotlight-ui*:log-stream*",
      "arn:aws:logs:*:${data.aws_caller_identity.current.account_id}:log-group:/aws/api-gateway/capterra-spotlight-ui*:log-stream*",
      "arn:aws:logs:*:${data.aws_caller_identity.current.account_id}:log-group:/aws/api-gateway/capterra-spotlight-ui*"
    ]
  }
