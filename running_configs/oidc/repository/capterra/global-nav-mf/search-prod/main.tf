...
data "aws_iam_policy_document" "github_actions_global_nav_mf" {
  ...
  statement {
    ...
    resources = [
      ...
      "arn:aws:cloudformation:*:${data.aws_caller_identity.current.account_id}:stack/capterra-${var.application}-service-staging/*"
    ]
  }
  ...
  statement {
    ...
    resources = [
      ...
      "arn:aws:logs:*:${data.aws_caller_identity.current.account_id}:log-group:/aws/api-gateway/staging-capterra-${var.application}*",
      ...
      "arn:aws:logs:*:${data.aws_caller_identity.current.account_id}:log-group:/aws/api-gateway/staging-capterra-${var.application}*:log-stream*"
    ]
  }
}
