...
data "aws_iam_policy_document" "github_actions_blog_ui" {
  ...
  statement {
    ...
    resources = [
      ...
      "arn:aws:apigateway:*::/domainnames/api.resources.capterra.com",
      "arn:aws:apigateway:*::/restapis/*/resources/*",
      "arn:aws:apigateway:*::/domainnames/api.resources.capterra.com/apimappings",
      "arn:aws:apigateway:*::/domainnames/api.resources.capterra.com/apimappings/*",
    ]
  }
  ...
  statement {
    ...
    resources = [
      "arn:aws:apigateway:${data.aws_region.current.name}::/restapis/*/stages/prod",
      "arn:aws:apigateway:${data.aws_region.current.name}::/restapis/*/stages/prod*",
      "arn:aws:wafv2:${data.aws_region.current.name}:${data.aws_caller_identity.current.account_id}:*/webacl/capterra-blog-api-prod-waf/*"
    ]
  }

  statement {
    actions   = ["route53:ChangeResourceRecordSets"]
    resources = ["arn:aws:route53:::hostedzone/Z30OS86JINAD69"]
  }
  ...
  statement {
    ...
    resources = [
      "arn:aws:cloudformation:${data.aws_region.current.name}:${data.aws_caller_identity.current.account_id}:stack/blog-ui-cf-maintainer-api-prod/*"
    ]
  }
  ...
  statement {
    ...
    resources = [
    "arn:aws:iam::${data.aws_caller_identity.current.account_id}:role/blog-ui-cf-maintainer-api-prod",
    "arn:aws:iam::${data.aws_caller_identity.current.account_id}:role/blog-ui-cf-maintainer-api-prod*"
    ]
  }
  ...
  statement {
    ...
    resources = [
      "arn:aws:lambda:${data.aws_region.current.name}:${data.aws_caller_identity.current.account_id}:function:blog-ui-cf-maintainer-api-prod",
      "arn:aws:lambda:${data.aws_region.current.name}:${data.aws_caller_identity.current.account_id}:function:blog-ui-cf-maintainer-api-prod:*",
      "arn:aws:lambda:${data.aws_region.current.name}:${data.aws_caller_identity.current.account_id}:function:blog-ui-cf-maintainer-api-prod*",
      "arn:aws:lambda:${data.aws_region.current.name}:${data.aws_caller_identity.current.account_id}:function:blog-ui-cf-maintainer-api-prod*:*"
    ]
  ...
  statement {
    ...
    resources = [
      "arn:aws:logs:${data.aws_region.current.name}:${data.aws_caller_identity.current.account_id}:log-group:blog-ui-cf-maintainer-api-prod",
      "arn:aws:logs:${data.aws_region.current.name}:${data.aws_caller_identity.current.account_id}:log-group:blog-ui-cf-maintainer-api-prod*",
      "arn:aws:logs:${data.aws_region.current.name}:${data.aws_caller_identity.current.account_id}:log-group:/aws/lambda/blog-ui-cf-maintainer-api-prod",
      "arn:aws:logs:${data.aws_region.current.name}:${data.aws_caller_identity.current.account_id}:log-group:/aws/lambda/blog-ui-cf-maintainer-api-prod*",
    ]
  }
}
