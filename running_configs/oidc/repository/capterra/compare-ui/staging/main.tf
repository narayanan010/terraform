...
resource "aws_iam_role" "github_actions_compare_ui" {
  name               = "github-actions-compare-ui-${var.environment}"
...
data "aws_iam_policy_document" "github_actions_compare_ui" {
  ...
  statement {
    ...
    resources = [
      "arn:aws:cloudformation:${data.aws_region.current.name}:${data.aws_caller_identity.current.account_id}:stack/capterra-compare-ui-*/*",
      "arn:aws:cloudformation:${data.aws_region.current.name}:${data.aws_caller_identity.current.account_id}:stack/capterra-compare-ui-service-staging/*"
    ]
  }
  ...
  statement {
    ...
    resources = [
      "arn:aws:iam::${data.aws_caller_identity.current.account_id}:role/capterra-compare-ui*",
      "arn:aws:iam::${data.aws_caller_identity.current.account_id}:role/capterra-compare-ui"
      ]
  }
  ...
  statement {
    ...
    resources = [
      ...
      "arn:aws:lambda:${data.aws_region.current.name}:${data.aws_caller_identity.current.account_id}:function:capterra-compare-ui*",
      "arn:aws:lambda:${data.aws_region.current.name}:${data.aws_caller_identity.current.account_id}:function:capterra-compare-ui*:*",
  ...
  statement {
    ...
    resources = [
      "arn:aws:s3:::capterra-compare-ui*",
      "arn:aws:s3:::capterra-compare-ui*/*",
      "arn:aws:s3:::compare-ui*",
      "arn:aws:s3:::compare-ui*/*",
    ]
  }
  ...
  statement {
    ...
    resources = [
      "arn:aws:logs:${data.aws_region.current.name}:${data.aws_caller_identity.current.account_id}:log-group:/aws/lambda/capterra-compare-ui*",
      "arn:aws:logs:${data.aws_region.current.name}:${data.aws_caller_identity.current.account_id}:log-group:/aws/api-gateway/capterra-compare-ui*",
      "arn:aws:logs:${data.aws_region.current.name}:${data.aws_caller_identity.current.account_id}:log-group:/aws/lambda/capterra-compare-ui*:log-stream:*",
      "arn:aws:logs:${data.aws_region.current.name}:${data.aws_caller_identity.current.account_id}:log-group:/aws/api-gateway/capterra-compare-ui*:log-stream*"
    ]
  }
