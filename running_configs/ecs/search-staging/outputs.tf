...
# CloudWatch
output "cw_logs_datadog_agent" {
  value       = aws_cloudwatch_log_group.datadog_agent.name
  description = "CloudWatch datadog_agent logs group name"
}

output "cw_metrics_stream" {
  value       = aws_cloudwatch_metric_stream.kinesis_stream.name
  description = "CloudWatch datadog_agent logs group name"
}
...
output "codedeploy_api_bluegreen" {
  value       = aws_codedeploy_app.api_bluegreen_ecs.arn
  description = "Codedeploy bluegreen ARN"
}
