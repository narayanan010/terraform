...
data "aws_iam_policy_document" "ecs_agent" {
  ...
  statement {
    ...
    principals {
      type        = "AWS"
      identifiers = ["arn:aws:iam::932799032166:role/dm-buyer-activation-msk-serviceaccount-role-qa"]
    }
  }
}
...
resource "aws_iam_role_policy" "ec2_agent_inline_pol04" {
  name = "msk_policy"
  role = aws_iam_role.ecs_agent.name
  policy = jsonencode(
    {
      "Statement" : [
        {
          ...
          "Effect" : "Allow",
          "Resource" : [
            "arn:aws:iam::932799032166:role/dm-buyer-activation-msk-serviceaccount-role-qa"
          ],
          "Sid" : "stsAssumeRole"
        },
        {
          ...
          "Effect" : "Allow",
          "Resource" : [
            "arn:aws:kafka:us-east-1:932799032166:cluster/dm-infra-msk-qa/8a615e40-1f8d-4c38-90a7-383b38be575a-23",
            "arn:aws:kafka:us-east-1:932799032166:configuration/dm-infra-msk-qa/8a615e40-1f8d-4c38-90a7-383b38be575a-23"
          ],
          "Sid" : "kafkaclusterget"
        },
        {
          ...
          "Effect" : "Allow",
          "Resource" : [
            "arn:aws:kafka:us-east-1:932799032166:transactional-id/*/*/*",
            "arn:aws:kafka:us-east-1:932799032166:cluster/dm-infra-msk-qa/8a615e40-1f8d-4c38-90a7-383b38be575a-23",
            "arn:aws:kafka:us-east-1:932799032166:topic/dm-infra-msk-qa/8a615e40-1f8d-4c38-90a7-383b38be575a-23/*",
            "arn:aws:kafka:us-east-1:932799032166:group/dm-infra-msk-qa/8a615e40-1f8d-4c38-90a7-383b38be575a-23/*"
          ],
          "Sid" : "kafkatopicget"
        },
        {
          ...
          "Effect" : "Allow",
          "Resource" : [
            "arn:aws:kafka:us-east-1:932799032166:topic/dm-infra-msk-qa/8a615e40-1f8d-4c38-90a7-383b38be575a-23/gdm_ba_*",
            "arn:aws:kafka:us-east-1:932799032166:topic/dm-infra-msk-qa/8a615e40-1f8d-4c38-90a7-383b38be575a-23/uw_cap_*"
          ],
          "Sid" : "kafkatopicread"
        },
        {
