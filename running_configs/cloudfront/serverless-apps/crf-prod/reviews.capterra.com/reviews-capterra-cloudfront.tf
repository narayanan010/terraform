...
# __generated__ by Terraform from "E4SP86T2B4BWJ"
resource "aws_cloudfront_distribution" "reviews-capterra-cloudfront" {
  aliases             = ["reviews.capterra.com"]
  comment             = null
  ...
  logging_config {
    ...
    prefix          = "738909422062/E4SP86T2B4BWJ"
  }
  ordered_cache_behavior {
    ...
    response_headers_policy_id = null
    smooth_streaming           = false
    target_origin_id           = "origin-s3-gdm-crf-capterra-prd"
    trusted_key_groups         = []
    trusted_signers            = []
    viewer_protocol_policy     = "redirect-to-https"
    forwarded_values {
  ...
  ordered_cache_behavior {
    ...
    response_headers_policy_id = null
    smooth_streaming           = false
    target_origin_id           = "S3-crf-capterra-prd-cdn"
    trusted_key_groups         = []
    trusted_signers            = []
    viewer_protocol_policy     = "redirect-to-https"
    forwarded_values {
  ...
  ordered_cache_behavior {
    ...
    response_headers_policy_id = null
    smooth_streaming           = false
    target_origin_id           = "origin-api-gdm-crf-capterra-prd"
    trusted_key_groups         = []
    trusted_signers            = []
    viewer_protocol_policy     = "redirect-to-https"
    forwarded_values {
  ...
  origin {
    ...
    origin_id                = "origin-api-gdm-crf-capterra-prd"
    origin_path              = "/prod"
    custom_header {
  ...
  origin {
    ...
    origin_access_control_id = var.oac
  ...
  origin {
    ...
    origin_access_control_id = var.oac
    origin_id                = "S3-crf-capterra-prd-cdn"
  }
  origin {
    connection_attempts      = 3
    connection_timeout       = 10
    domain_name              = "central-review-form-prd.s3.amazonaws.com"
    origin_access_control_id = var.oac
    origin_id                = "origin-s3-gdm-crf-capterra-prd"
    origin_path              = null
  }
  restrictions {
    geo_restriction {
