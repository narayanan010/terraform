...
# __generated__ by Terraform from "E1X4VT3K3WLW0K"
resource "aws_cloudfront_distribution" "reviews-ga-prod" {
  aliases             = ["reviews.getapp.com"]
  comment             = null
  ...
  logging_config {
    ...
    prefix          = "738909422062/E1X4VT3K3WLW0K"
  }
  ordered_cache_behavior {
    ...
    response_headers_policy_id = null
    smooth_streaming           = false
    target_origin_id           = "origin-s3-gdm-crf-getapp-prd"
    trusted_key_groups         = []
    trusted_signers            = []
    viewer_protocol_policy     = "redirect-to-https"
    forwarded_values {
  ...
  ordered_cache_behavior {
    ...
    response_headers_policy_id = null
    smooth_streaming           = false
    target_origin_id           = "S3-crf-getapp-prd-cdn"
    trusted_key_groups         = []
    trusted_signers            = []
    viewer_protocol_policy     = "redirect-to-https"
    forwarded_values {
  ...
  ordered_cache_behavior {
    ...
    response_headers_policy_id = null
    smooth_streaming           = false
    target_origin_id           = "origin-api-gdm-crf-getapp-prd"
    trusted_key_groups         = []
    trusted_signers            = []
    viewer_protocol_policy     = "redirect-to-https"
    forwarded_values {
  ...
  origin {
    ...
    origin_id                = "origin-api-gdm-crf-getapp-prd"
    origin_path              = "/prod"
    custom_header {
  ...
  origin {
    ...
    origin_access_control_id = var.cf_origin_access_control
    origin_id                = "S3-crf-getapp-prd-cdn"
  }
  origin {
    connection_attempts      = 3
    connection_timeout       = 10
    domain_name              = "central-review-form-prd.s3.amazonaws.com"
    origin_access_control_id = var.cf_origin_access_control
    origin_id                = "origin-s3-gdm-crf-getapp-prd"
    origin_path              = null
  }
  restrictions {
    geo_restriction {
  ...
  viewer_certificate {
    acm_certificate_arn            = "arn:aws:acm:us-east-1:738909422062:certificate/dfe40b8a-be45-41c9-aa4c-2b0b82a1ba7d"
