...
variable "cloudformationstackname" {
	description = "cloudformationstackname to be passed to module. Eg: capterra-sem-ui-service-staging"
}

variable "cert_domain_name" {
	description = "cert_domain_name to be passed to module. Eg: sem-ui.capstage.net"
}
...
variable "primary_s3_bucket" {
    type = string
    description = "Primary S3 Bucket name that CF distro S3 origin will point to. Eg: sem-ui-stg"
}
