...
data "aws_dynamodb_table" "tableName" {
  name = aws_dynamodb_table.blog-prod.id
}
...
module "aws_sqs_module" {
  ...
  slack_alert_webhook_parameter   = "/devops/slack/blog-ui/sqs-to-oracle-db/prod"
...
module "tags_resource_module" {
  ...
  application         = var.application
  app_component       = "survey-collector"
  function            = "survey-collector"
  business_unit       = "gdm"
