module "aws_redis_module" {
    ...
    region                               = "us-east-1"
    cluster_id                           = "compare-ui-staging-redis"
    engine                               = "redis"
    ...
    allowed_cidr_blocks                  = ["10.114.32.120/32","10.114.24.128/32","10.114.32.4/32","10.114.48.0/21","10.114.107.0/24","10.114.24.0/21","10.114.33.118/32"]
    #allowed_security_groups             = ["sg-03dc2808b9ca5f3a2"]
    providers                            = {
