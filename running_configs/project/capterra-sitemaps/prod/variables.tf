...
variable "wafID" {
    ...
    default = "arn:aws:wafv2:us-east-1:176540105868:global/webacl/capterra-security-main-global-prod-waf/48f5a70f-f975-4f89-9c3c-060ae7788c6c"
}
