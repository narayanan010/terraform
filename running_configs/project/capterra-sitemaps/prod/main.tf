...
resource "aws_cloudfront_distribution" "s3_distribution" {
  ...
  origin {
    domain_name = "capterra-sitemap-prod.s3.amazonaws.com"
    origin_id   = "origin-s3"
  ...
  comment         = "This is for hosting prod env of serverless app named- Sitemaps"
