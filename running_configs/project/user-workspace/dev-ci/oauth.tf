resource "aws_cognito_user_pool" "uw_oauth_pool_dev_ga" {
  name = "ga-user-workspace-${var.stage}-${var.pool_type}"
...
resource "aws_cognito_user_pool_client" "uw_google_client_ga" {
    name = "ga-userworkspace-oauth-client-${var.stage}"
    user_pool_id = "${aws_cognito_user_pool.uw_oauth_pool_dev_ga.id}"
