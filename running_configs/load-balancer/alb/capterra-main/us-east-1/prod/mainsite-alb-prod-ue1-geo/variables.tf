...
variable "waf_arn" {
  default     = "arn:aws:wafv2:us-east-1:176540105868:regional/webacl/mainsite-acl-prod-us-east-1/71eede4a-5311-4eac-a204-7647265afe62"
  description = "WAF ACL ARN to be associated with the Load Balancer"
  type        = string  
}
