module "aws_waf_module" {
  source = "git@github.com:capterra/terraform.git//modules/aws-waf?ref=aws-waf-v1.0.1"
  ...
  # Allow Contentful LIST rule
  custom_app_name                                                                 = "contentful"
  custom_allow_app_ip_list_status                                                 = "allow"
  custom_allow_app_ip_list_rule_priority                                          = 4
  custom_allow_app_ip_list_and_statement                                          = true
  custom_allow_app_ip_list_address_version                                        = "IPV4"
  custom_allow_app_ip_list_addresses                                              = ["18.214.214.181/32", "23.22.58.212/32", "35.175.4.28/32", 
                                                                                     "50.16.105.152/32", "54.91.243.203/32", "54.147.156.145/32", 
                                                                                     "44.196.27.223/32", "100.24.203.24/32", "54.80.73.183/32"]
  custom_allow_app_ip_list_positional_constraint                                  = "EXACTLY"
  custom_allow_app_ip_list_search_string                                          = "/resources/api/isr/"
