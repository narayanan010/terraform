module "aws_waf_module" {
  ...
  custom_path_size_checker_action_list = [
    { uri_path = "/admin/badges", uri_path_constraint = "CONTAINS", size = 8192, size_comparison_operator = "GE", action = "allow", priority = 0 },
    { uri_path = "/admin/badges/import", uri_path_constraint = "CONTAINS", size = 8192, size_comparison_operator = "GE", action = "allow", priority = 1 },
  ]

  # Oversized requests
  oversized_body_requests_rule_status                                              = "block"
  oversized_body_requests_rule_priority                                            = 2
  oversized_headers_requests_rule_status                                           = "block"
  oversized_headers_requests_rule_priority                                         = 3
  oversized_cookies_requests_rule_status                                           = "block"
  oversized_cookies_requests_rule_priority                                         = 4
  ...
  nginx_servers_ip_list_addresses                                                 = ["52.13.209.160/32", "34.205.192.229/32", "3.233.207.165/32",
                                                                                    ...
                                                                                    "52.39.77.81/32", "3.81.245.224/32"]
