module "aws_waf_module" {
  ...
  aws_managed_rules_ip_reputation_list_priority                              = 1
  ...
  aws_managed_rules_common_rule_set_SizeRestrictions_BODY_excluded           = true
