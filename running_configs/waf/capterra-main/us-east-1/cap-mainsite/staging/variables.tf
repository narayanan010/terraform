...
variable "bstack_search_string" {
  type        = string
  default     = ""
  description = "Search String to validate Header based auth for Browserstack sent traffic."
}

variable "blog_search_string" {
  type        = string
  default     = ""
  description = "Search String to validate Header based auth for Blog on capstage.net."
}

variable "lytics_search_string" {
  type        = string
  default     = ""
  description = "Search String to validate Header based auth for Lytics sent traffic."
}
