...
module "aws_vpc_mod" {
    ...
    #source                      = "git@github.com:capterra/terraform-vpc.git?ref=refactor/TFv0.13"
    #source                      = "/Users/daoliva/repo/work/capterra/terraform-vpc"  
    vpc_cidr_block              = "10.114.152.0/21"
    vpc_private_subnet_count    = "2"    
    vpc_private_subnet_cidr     = ["10.114.152.0/24","10.114.153.0/24"]
    vpc_public_subnet_count     = "2"
    vpc_public_subnet_cidr      = ["10.114.158.0/24","10.114.159.0/24"]
