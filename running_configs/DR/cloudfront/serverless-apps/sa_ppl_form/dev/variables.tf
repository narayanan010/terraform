...
variable "cert_domain_name" {
  description = "cert_domain_name to be passed to module. Eg: sa-ppl-form-dr.capstage.net"
  default     = "sa-ppl-form-dr.capstage.net"
}
...
variable "primary_s3_bucket" {
  type        = string
  description = "Primary S3 Bucket name that CF distro S3 origin will point to. Eg: sa-ppl-form-dev-dr"
  default     = "sa-ppl-form-dev-dr"
}
